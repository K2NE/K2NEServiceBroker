...
namespace K2Field.K2NE.ServiceBroker.ServiceObjects
{
    class ADOSMOQuerySO : ServiceObjectBase
    {
        ...
        public override List<ServiceObject> DescribeServiceObjects()
        {
            ...
            foreach (KeyValuePair<string, string> query in ADOSMOQueries)
            {
                ...
                */
                ...
                Method mExcelFromADOQuery = Helper.CreateMethod(Constants.Methods.ExportToExcel.ExcelFromADOQuery, "Generate an Excel file based on ADO query", MethodType.Execute);
        ...
        private void ExportToExcel()
        {
            ...
            using (CreateExcelWrapper excelWrapper = new CreateExcelWrapper())
            {
                using (CreateExcel excel = excelWrapper.GetCreateExcelByNewDomain(base.BaseAPIConnectionString))
                {
                    using (SOConnection connection = new SOConnection(base.BaseAPIConnectionString))
