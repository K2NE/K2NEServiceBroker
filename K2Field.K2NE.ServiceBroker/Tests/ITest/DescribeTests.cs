...
namespace K2Field.K2NE.ServiceBroker.ITest
{
    ...
    public class DescribeTests
    {
        ...
        public void A02_Describe_ServiceType_K2NEServiceBroker()
        {
            ...
            Assert.AreEqual(14, serviceConfigInfo.ConfigSettings.Count);
            Assert.AreEqual("Workflow Management Port", serviceConfigInfo.ConfigSettings[0].DisplayName);
            Assert.AreEqual(true, serviceConfigInfo.ConfigSettings[0].IsRequired);
            Assert.AreEqual("Workflow Management Port", serviceConfigInfo.ConfigSettings[0].Name);
            Assert.AreEqual("5555", serviceConfigInfo.ConfigSettings[0].Value ?? string.Empty);
            ...
            Assert.AreEqual("Workflow Client Port", serviceConfigInfo.ConfigSettings[2].DisplayName);
            Assert.AreEqual(true, serviceConfigInfo.ConfigSettings[2].IsRequired);
            Assert.AreEqual("Workflow Client Port", serviceConfigInfo.ConfigSettings[2].Name);
            Assert.AreEqual("5252", serviceConfigInfo.ConfigSettings[2].Value ?? string.Empty);
            Assert.AreEqual("Environment to use (empty for default)", serviceConfigInfo.ConfigSettings[3].DisplayName);
            Assert.AreEqual(false, serviceConfigInfo.ConfigSettings[3].IsRequired);
            Assert.AreEqual("Environment to use (empty for default)", serviceConfigInfo.ConfigSettings[3].Name);
            Assert.AreEqual("", serviceConfigInfo.ConfigSettings[3].Value ?? string.Empty);
            Assert.AreEqual("AD LDAP Path", serviceConfigInfo.ConfigSettings[4].DisplayName);
            Assert.AreEqual(false, serviceConfigInfo.ConfigSettings[4].IsRequired);
            Assert.AreEqual("AD LDAP Path", serviceConfigInfo.ConfigSettings[4].Name);
            Assert.AreEqual("LDAP://DC=denallix,DC=COM", serviceConfigInfo.ConfigSettings[4].Value ?? string.Empty);
            Assert.AreEqual("AD Maximum Resultsize", serviceConfigInfo.ConfigSettings[5].DisplayName);
            Assert.AreEqual(false, serviceConfigInfo.ConfigSettings[5].IsRequired);
            Assert.AreEqual("AD Maximum Resultsize", serviceConfigInfo.ConfigSettings[5].Name);
            Assert.AreEqual("1000", serviceConfigInfo.ConfigSettings[5].Value ?? string.Empty);
            Assert.AreEqual("Change Contains operator to StartsWith for AD", serviceConfigInfo.ConfigSettings[6].DisplayName);
            Assert.AreEqual(true, serviceConfigInfo.ConfigSettings[6].IsRequired);
            Assert.AreEqual("Change Contains operator to StartsWith for AD", serviceConfigInfo.ConfigSettings[6].Name);
            Assert.AreEqual("true", serviceConfigInfo.ConfigSettings[6].Value ?? string.Empty);
            Assert.AreEqual("Default Culture", serviceConfigInfo.ConfigSettings[7].DisplayName);
            Assert.AreEqual(true, serviceConfigInfo.ConfigSettings[7].IsRequired);
            Assert.AreEqual("Default Culture", serviceConfigInfo.ConfigSettings[7].Name);
            Assert.AreEqual("EN-us", serviceConfigInfo.ConfigSettings[7].Value ?? string.Empty);
            Assert.AreEqual("SMO data queries file path", serviceConfigInfo.ConfigSettings[8].DisplayName);
            Assert.AreEqual(false, serviceConfigInfo.ConfigSettings[8].IsRequired);
            Assert.AreEqual("SMO data queries file path", serviceConfigInfo.ConfigSettings[8].Name);
            Assert.AreEqual("", serviceConfigInfo.ConfigSettings[8].Value ?? string.Empty);
            Assert.AreEqual("PowerShell Subdirectories", serviceConfigInfo.ConfigSettings[9].DisplayName);
            Assert.AreEqual(false, serviceConfigInfo.ConfigSettings[9].IsRequired);
            Assert.AreEqual("PowerShell Subdirectories", serviceConfigInfo.ConfigSettings[9].Name);
            Assert.AreEqual("PowerShellScripts", serviceConfigInfo.ConfigSettings[9].Value ?? string.Empty);
            Assert.AreEqual("Additional AD properties delimited by ;", serviceConfigInfo.ConfigSettings[10].DisplayName);
            Assert.AreEqual(false, serviceConfigInfo.ConfigSettings[10].IsRequired);
            Assert.AreEqual("Additional AD properties delimited by ;", serviceConfigInfo.ConfigSettings[10].Name);
            Assert.AreEqual("", serviceConfigInfo.ConfigSettings[10].Value ?? string.Empty);
            Assert.AreEqual("SMO data queries delimited by ;", serviceConfigInfo.ConfigSettings[11].DisplayName);
            Assert.AreEqual(false, serviceConfigInfo.ConfigSettings[11].IsRequired);
            Assert.AreEqual("SMO data queries delimited by ;", serviceConfigInfo.ConfigSettings[11].Name);
            Assert.AreEqual("", serviceConfigInfo.ConfigSettings[11].Value ?? string.Empty);
            Assert.AreEqual("Allow Simple PowerShell Scripts", serviceConfigInfo.ConfigSettings[12].DisplayName);
            Assert.AreEqual(true, serviceConfigInfo.ConfigSettings[12].IsRequired);
            Assert.AreEqual("Allow Simple PowerShell Scripts", serviceConfigInfo.ConfigSettings[12].Name);
            Assert.AreEqual("true", serviceConfigInfo.ConfigSettings[12].Value ?? string.Empty);
            Assert.AreEqual("Platform to use", serviceConfigInfo.ConfigSettings[13].DisplayName);
            Assert.AreEqual(false, serviceConfigInfo.ConfigSettings[13].IsRequired);
            Assert.AreEqual("Platform to use", serviceConfigInfo.ConfigSettings[13].Name);
            Assert.AreEqual("ASP", serviceConfigInfo.ConfigSettings[13].Value ?? string.Empty);
        }
        ...
        [TestMethod]
        [TestCategory("Describe K2NEServiceBroker")]
        public void Describe_Process_Instance_Client()
        {
            var serviceObject = SmartObjectHelper.GetServiceObject(K2NEServiceBrokerIntegrationTestsServiceInstanceSettings.Instance, "ProcessInstanceClient");

            // SERVICEOBJECT: ProcessInstanceClient
            Assert.AreEqual("ProcessInstanceClient", serviceObject.Name);
            Assert.AreEqual("Process Instance Client", serviceObject.Metadata.DisplayName);
            Assert.AreEqual("", serviceObject.ServiceObjectType ?? string.Empty);

            // PROPERTIES: ProcessInstanceClient
            Assert.AreEqual(5, serviceObject.Properties.Count);

            Assert.AreEqual("Folio", serviceObject.Properties[0].Name);
            Assert.AreEqual("Folio", serviceObject.Properties[0].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Text, serviceObject.Properties[0].Type);

            Assert.AreEqual("ProcessName", serviceObject.Properties[1].Name);
            Assert.AreEqual("Process Name", serviceObject.Properties[1].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Text, serviceObject.Properties[1].Type);

            Assert.AreEqual("StartSynchronous", serviceObject.Properties[2].Name);
            Assert.AreEqual("Start Synchronous", serviceObject.Properties[2].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.YesNo, serviceObject.Properties[2].Type);

            Assert.AreEqual("ProcessInstanceId", serviceObject.Properties[3].Name);
            Assert.AreEqual("Process Instance Id", serviceObject.Properties[3].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Number, serviceObject.Properties[3].Type);

            Assert.AreEqual("ProcessVersion", serviceObject.Properties[4].Name);
            Assert.AreEqual("Process Version", serviceObject.Properties[4].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Number, serviceObject.Properties[4].Type);

            // METHODS: ProcessInstanceClient
            Assert.AreEqual(3, serviceObject.Methods.Count);

            // Method: StartProcessInstance
            Assert.AreEqual("Start Process Instance", serviceObject.Methods[0].Metadata.DisplayName);
            Assert.AreEqual("StartProcessInstance", serviceObject.Methods[0].Name);
            Assert.AreEqual(MethodDefinitionType.create, serviceObject.Methods[0].Type);

            // Input Properties: StartProcessInstance
            Assert.AreEqual(4, serviceObject.Methods[0].InputProperties.Count);
            Assert.AreEqual("ProcessName", serviceObject.Methods[0].InputProperties[0].Name);
            Assert.AreEqual("Folio", serviceObject.Methods[0].InputProperties[1].Name);
            Assert.AreEqual("ProcessVersion", serviceObject.Methods[0].InputProperties[2].Name);
            Assert.AreEqual("StartSynchronous", serviceObject.Methods[0].InputProperties[3].Name);

            // Required Properties: StartProcessInstance
            Assert.AreEqual(1, serviceObject.Methods[0].Validation.RequiredProperties.Count);
            Assert.AreEqual("ProcessName", serviceObject.Methods[0].Validation.RequiredProperties[0].Name);

            // Parameters: StartProcessInstance
            Assert.AreEqual(0, serviceObject.Methods[0].Parameters.Count);

            // Return Properties: StartProcessInstance
            Assert.AreEqual(2, serviceObject.Methods[0].ReturnProperties.Count);
            Assert.AreEqual("ProcessInstanceId", serviceObject.Methods[0].ReturnProperties[0].Name);
            Assert.AreEqual("Folio", serviceObject.Methods[0].ReturnProperties[1].Name);

            // Method: SetFolio
            Assert.AreEqual("Set Folio", serviceObject.Methods[1].Metadata.DisplayName);
            Assert.AreEqual("SetFolio", serviceObject.Methods[1].Name);
            Assert.AreEqual(MethodDefinitionType.update, serviceObject.Methods[1].Type);

            // Input Properties: SetFolio
            Assert.AreEqual(2, serviceObject.Methods[1].InputProperties.Count);
            Assert.AreEqual("ProcessInstanceId", serviceObject.Methods[1].InputProperties[0].Name);
            Assert.AreEqual("Folio", serviceObject.Methods[1].InputProperties[1].Name);

            // Required Properties: SetFolio
            Assert.AreEqual(1, serviceObject.Methods[1].Validation.RequiredProperties.Count);
            Assert.AreEqual("ProcessInstanceId", serviceObject.Methods[1].Validation.RequiredProperties[0].Name);
            ...
            // Return Properties: SetFolio
            Assert.AreEqual(0, serviceObject.Methods[1].ReturnProperties.Count);

            // Method: SC\Customer Approval Workflow
            Assert.AreEqual(@"Start_SC\Customer Approval Workflow", serviceObject.Methods[2].Metadata.DisplayName);
            Assert.AreEqual(@"SC\Customer Approval Workflow", serviceObject.Methods[2].Name);
            Assert.AreEqual(MethodDefinitionType.create, serviceObject.Methods[2].Type);

            // Input Properties: SC\Customer Approval Workflow
            Assert.AreEqual(3, serviceObject.Methods[2].InputProperties.Count);
            Assert.AreEqual("Folio", serviceObject.Methods[2].InputProperties[0].Name);
            Assert.AreEqual("StartSynchronous", serviceObject.Methods[2].InputProperties[1].Name);
            Assert.AreEqual("ProcessVersion", serviceObject.Methods[2].InputProperties[2].Name);

            // Required Properties: SC\Customer Approval Workflow
            Assert.AreEqual(0, serviceObject.Methods[2].Validation.RequiredProperties.Count);

            // Parameters: SC\Customer Approval Workflow
            Assert.AreEqual(5, serviceObject.Methods[2].Parameters.Count);
            Assert.AreEqual("Requested Car", serviceObject.Methods[2].Parameters[0].Name);
            Assert.AreEqual("Requested Car", serviceObject.Methods[2].Parameters[0].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Text, serviceObject.Methods[2].Parameters[0].Type);
            Assert.AreEqual(false, serviceObject.Methods[2].Parameters[0].IsRequired);
            Assert.AreEqual("ProcessXML", serviceObject.Methods[2].Parameters[1].Name);
            Assert.AreEqual("Process XML", serviceObject.Methods[2].Parameters[1].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Text, serviceObject.Methods[2].Parameters[1].Type);
            Assert.AreEqual(false, serviceObject.Methods[2].Parameters[1].IsRequired);
            Assert.AreEqual("InputXML", serviceObject.Methods[2].Parameters[2].Name);
            Assert.AreEqual("Input XML", serviceObject.Methods[2].Parameters[2].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Text, serviceObject.Methods[2].Parameters[2].Type);
            Assert.AreEqual(false, serviceObject.Methods[2].Parameters[2].IsRequired);
            Assert.AreEqual("ProcessGuid", serviceObject.Methods[2].Parameters[3].Name);
            Assert.AreEqual("Process Guid", serviceObject.Methods[2].Parameters[3].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Text, serviceObject.Methods[2].Parameters[3].Type);
            Assert.AreEqual(false, serviceObject.Methods[2].Parameters[3].IsRequired);
            Assert.AreEqual("Car Approval_WDRuntimeTaskFields", serviceObject.Methods[2].Parameters[4].Name);
            Assert.AreEqual("Car Approval_ WD Runtime Task Fields", serviceObject.Methods[2].Parameters[4].Metadata.DisplayName);
            Assert.AreEqual(PropertyDefinitionType.Text, serviceObject.Methods[2].Parameters[4].Type);
            Assert.AreEqual(false, serviceObject.Methods[2].Parameters[4].IsRequired);

            // Return Properties: SC\Customer Approval Workflow
            Assert.AreEqual(2, serviceObject.Methods[2].ReturnProperties.Count);
            Assert.AreEqual("ProcessInstanceId", serviceObject.Methods[2].ReturnProperties[0].Name);
            Assert.AreEqual("Folio", serviceObject.Methods[2].ReturnProperties[1].Name);

            // ASSOCIATIONS: ProcessInstanceClient
            Assert.AreEqual(0, serviceObject.Associations.Count);
        }
