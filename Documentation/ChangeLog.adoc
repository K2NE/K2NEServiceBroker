...
==== ADO SMO Query:
- Refactored code
- Changed logic to pass smartobject properties to query. Now using HAVING operator is deprecated. See link:ADOSMOQuery.adoc[ADO SMO Query service object] for more information.
